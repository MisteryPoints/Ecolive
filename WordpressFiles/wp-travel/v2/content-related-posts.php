...
$no_related_post_message = '<p class="wp-travel-no-detail-found-msg">' . esc_html__( 'Related trip not found.', 'travel-master' ) . '</p>';
...
<div class="wp-travel-related-posts wp-travel-container-wrap <?php echo esc_attr( $wrapper_class ); ?>">
	<h2><?php echo apply_filters( 'wp_travel_related_post_title', esc_html__( 'Related Trips', 'travel-master' ) ); ?></h2>
