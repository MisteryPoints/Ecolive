            ...
            <div className="row">
                <div className="col-lg-6 h-100 text-center text-lg-start my-auto">
                    <ul className="list-inline mb-2">
                        ...
                        <li className="list-inline-item"><a href="#!">Contactos</a></li>
                        <li className="list-inline-item">⋅</li>
                        <li className="list-inline-item"><a href="#!">Terminos y Condiciones</a></li>
                        <li className="list-inline-item">⋅</li>
                        <li className="list-inline-item"><a href="#!">Política de Privacidad</a></li>
                    </ul>
                    <p className="text-muted small mb-4 mb-lg-0">&copy; EcoLive 2022. Todos los derechos reservados Ⓡ.</p>
                </div>
